  ...
  <path d="M8.5 15h5.5"/>
                ...
                >
                    <svg viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <path
                            d="M8.5 7.5h7c.97 0 1.75.78 1.75 1.75v5.5c0 .97-.78 1.75-1.75 1.75h-2.36l-2.04 2.02c-.35.35-.92.1-.92-.38v-1.64H8.5c-.97 0-1.75-.78-1.75-1.75V9.25C6.75 8.28 7.53 7.5 8.5 7.5Z"
                            fill="currentColor"
                        />
                        <path
                            d="M10.25 10.25h5M10.25 12.5h3.75"
                            stroke="currentColor"
                            stroke-width="1.3"
